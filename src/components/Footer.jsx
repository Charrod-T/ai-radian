	...
	return (
		...
		>
			...
			<div className='flex justify-between lg:items-center mx-lg:flex-col gap-10'>
				...
				>
					{/*src ={ ? insert logo dark : non dark logo} */}
					<img src={theme === 'dark'} className='w-32 sm:w-44' alt='' />
			...
			<h3 className='border-gray-300 dark:border-gray-600 my-6' />
			...
			>
				<p>Copyright 2025 © Charrod T. - All Rights Reserved</p>
